...
const firstHeadPos = [0, 0, 0]
const initialCameraPosition = [150, 150, 150]
const initialCameraTarget = m4.subtractVectors()

var cameraTarget = [...initialCameraTarget]
var cameraPosition = [...initialCameraPosition]
/* up = target * position */
var up = crossProduct(cameraTarget, cameraPosition)
...
function main() {
  ...
  const updateTargetAngle = (event, ui) => {
  ...
  const updateTargetHeight = (event, ui) => {
    target[1] = ui.value;
    drawScene();
  }
